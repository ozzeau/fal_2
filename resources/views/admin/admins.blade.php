                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($usr->image)
                                                    <img src="{{ !empty($usr->image) ? asset('storage/users/' . $usr->image) : asset('storage/icons/profile-placeholder.svg') }}" alt="User Image" style="max-width: 100px; max-height: 100px;">
                                                    @else
                                                    No Image
                                                    @endif
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $usr->updated_at }}</td>
                                                <td>
                                                    <form action="/admin/deleteAdmin/{{$usr->id}}" method="post">
                                                        @csrf
                                                        @method('delete')
